...
using NetScrapper.Models;
using System.Globalization;
using System.Net;
using System.Xml.Linq;

namespace NetScrapper.Controllers
{
    ...
    public class AnalyticsController : ControllerBase
    {
        ...
        public AnalyticsController(MyDbContext dbContext, IConfiguration configuration)
        {
        ...
        public async Task<ActionResult> CreatePosts(string authorId)
        {
                ...
                Parallel.ForEach(feeds, new ParallelOptions { MaxDegreeOfParallelism = parallelTasksCount }, async feed =>
                {
                    ...
                    if (result.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        if (view != null)
                        {
                            ...
                            {
                                _ = decimal.TryParse(articleMatrix.Views, out decimal viewsCount);
                                articleMatrix.ViewsCount = viewsCount;
                            }
                        }
                        else
                        {
            ...
            {
                return BadRequest("Invalid Author Id / Unhadnled error. Please try again.");
            }
        }
    }
}
